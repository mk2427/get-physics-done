...
def test_fast_suite_exclusions_stay_centralized_and_narrow() -> None:
    ...
    assert "core/test_executor_prompt_contract_visibility.py" not in tests_conftest.FAST_SUITE_EXCLUDES
    assert "core/test_plan_contract_prompt_visibility_regressions.py" not in tests_conftest.FAST_SUITE_EXCLUDES
    ...
    assert "core/test_contract_validation_smoke.py" not in tests_conftest.FAST_SUITE_EXCLUDES
    assert "core/test_frontmatter_smoke.py" not in tests_conftest.FAST_SUITE_EXCLUDES
